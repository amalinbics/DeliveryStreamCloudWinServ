...
namespace DeliveryStreamCloudWinServ.DataAccess
{
    ...
    public class DALMethods
    {
        ...
        /// <param name="session">Session object</param>
        /// <returns>List of load</returns>
        public static List<DAL.LoadRow> GetUndispatchedLoad(ISession session, String VersionNo = "")
        {
            LoadTableAdapter ta = new LoadTableAdapter();
            ta.CurrentConnection = session;
            return ta.GetDataByUndispatched().ToList();
        }
        ...
        public static List<DAL.LoadStatusHistoryRow> GetUpdatedLoadStatusHistory(ISession session, String VersionNo = "")
        {
        ...
        public static List<DAL.OrderStatusHistoryRow> GetUpdatedOrderStatusHistory(ISession session, String VersionNo = "")
        {
        ...
        public static DataTable GetShipmentData1(Int32 maxRetryCount, ISession session, String VersionNo = "")
        {
        ...
        public static DataTable GetUpdatedDeliveryOrders1(Int32 maxRetryCount, ISession session, String VersionNo = "")
        {
            SqlCommand cmd = (SqlCommand)session.CreateCommand();
        ...
        public static DataTable GetRejectedLoads(ISession session, String VersionNo = "")
        {
            SqlCommand cmd = (SqlCommand)session.CreateCommand();
        ...
        public static DataTable GetDataToUpdateBOLImage(ISession session, String VersionNo = "")
        {
            SqlCommand cmd = (SqlCommand)session.CreateCommand();
        ...
        public static DataTable GetDataToUpdatePONo(ISession session, String VersionNo = "")
        {
            SqlCommand cmd = (SqlCommand)session.CreateCommand();
        ...
        public static DataTable FetchRejectedLoads(ISession session)
        {
            SqlConnection con = new SqlConnection(session.ConnectionString);
        ...
        public static DataTable FetchDeliveryNotes(ISession session)
        {
            SqlConnection con = new SqlConnection(session.ConnectionString);
